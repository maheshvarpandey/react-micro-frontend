  ...
  return (
    <Router>
      ...
      >
        ...
        <React.Suspense fallback="Loading...">
          <Switch>
            <Route exact path="/" render={() => renderMFE(DefaultComp)} />
            <Route path="/vertical" exact render={() => renderMFE(Vertical)} />
            <Route path="/horizontal" exact render={() => renderMFE(Horizontal)} />
          </Switch>
        </React.Suspense>
